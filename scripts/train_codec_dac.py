"""DAC codec training (48 kHz, 12 codebooks) -- the codec retrained for this paper.

This is NOT a Descript-released checkpoint: the DAC used in the paper is retrained
...
# Models
DAC = argbind.bind(dac_codec.model.DAC)
Discriminator = argbind.bind(dac_codec.model.Discriminator)
...
losses = argbind.bind_module(dac_codec.nn.loss, filter_fn=filter_fn)
...
def load(
    ...
    generator = DAC(test=None) if generator is None else generator
